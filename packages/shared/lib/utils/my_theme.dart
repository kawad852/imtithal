...
class MyTheme {
  ...
  ThemeData materialTheme(BuildContext context, ColorScheme colorScheme, {Color? fillColor}) {
    return ThemeData(
      useMaterial3: true,
      ...
      inputDecorationTheme: inputDecorationTheme(context, colorScheme, fillColor: fillColor),
    );
  }
}
